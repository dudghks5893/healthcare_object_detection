...
# 실행: python -m src.engine.v2_predict_2stage

TEST_IMG_DIR = Path("data/raw/test_images")
DETECTOR_WEIGHT = Path("runs/detect/outputs/stage1_detector_v2/baseline/weights/best.pt")
CLASSIFIER_WEIGHT = Path("outputs/stage2_classifier_v2/resnet18_fulltrain/best.pt")

SAVE_DIR = Path("outputs/submission")
SAVE_CSV = SAVE_DIR / "predict_2stage_v2.csv"
