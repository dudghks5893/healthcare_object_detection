...
# 실행: python -m src.engine.v2_train_stage2_classifier_fulltrain

FULL_TRAIN_CSV = Path("data/processed/v2/stage2_classifier/metadata/full_train_crop_labels_v2.csv")
SAVE_DIR = Path("outputs/stage2_classifier_v2/resnet18_fulltrain")
...
def main():
    ...
    with wandb.init(
        project="pill-classifier-v2",
        name="stage2_resnet18_fulltrain_v2",
        config={
            "mode": "full_train",
            "model": "resnet18",
            "pretrained": False,
        ...
        artifact = wandb.Artifact("stage2-classifier-fulltrain-v2", type="model")
