...
RAW_IMG_DIR = Path("data/v2/train_images")

SAVE_ROOT = Path("data/processed/v2/stage2_classifier")
...
def main():
    ...
    train_meta.to_csv(META_OUT / "train_crop_labels_v2.csv", index=False, encoding="utf-8-sig")
    val_meta.to_csv(META_OUT / "val_crop_labels_v2.csv", index=False, encoding="utf-8-sig")

    print("=== Stage2 crop dataset v2 생성 완료 ===")
