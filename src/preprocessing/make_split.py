...
"""
    ...
    [역할]
    master_annotations.csv를 이미지 단위로 train / val 분리
    ...
    [결과]
    data/processed/v../train_annotations.csv
    data/processed/v../val_annotations.csv
    data/processed/v../train_class_distribution.csv
    data/processed/v../val_class_distribution.csv
"""
