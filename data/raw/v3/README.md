...
구조는 아래와 같습니다.
stage1/train_annotations/xxxx.json (1개의 json에 모든 객체 정보 포함)
stage1/train_images/xxxx.png

stage2/train_annotations/xxxx.json (1개의 json에 모든 객체 정보 포함)
stage2/train_images/xxxx.png
